...
ads = ADS.ADS1115(i2c)
chan = AnalogIn(ads, ADS.P2, ADS.P3) # This puts ADC in differential mode which reads the voltage difference between pin 0 and pin 1
...
for i in range(nsamples): #loops and records data
    ...
    indata[i] = 0.001*ads.get_last_result() #Gets voltage in volts
