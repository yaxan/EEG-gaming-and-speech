...
while True:
    ...
    time_series[-1] = chan.value*(4.096/32767) #0.001 to convert mV -> V, adc ground is 3.3 volts above circuit ground, puts into most current time_series point
    ps = get_power_spectrum(time_series)
