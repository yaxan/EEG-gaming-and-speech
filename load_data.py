...
"""
while True:
    person_name = input('Please enter name to load data (yaz/joe/ruining):')
    if person_name in ['yaz', 'joe', 'ruining']:
        break
    else:
...
print("There are", concentrated_data.size, "concentrated data samples")
